...
class StyleSuggestion(BaseModel):
    ...
    clothes: List[str] = Field(description="List of short descriptions of the clothes to be used as queries")


class ProductSuggestion(BaseModel):
    name: str = Field(description="The name of the product")
    url: str = Field(description="The URL of the product")
    description: str = Field(description="Short description explaining why this product is selected")


class ProductSuggestions(BaseModel):
    products: List[ProductSuggestion] = Field(description="List of products suggested according to context and user's question")
