...
class ChainManager:
    def __init__(self, persist_directory, docstore_path, openai_token):
        ...
        self.stylist_chain_with_image = build_stylist_chain(self.llm_4o, with_image=True)
        self.stylist_chain_without_image = build_stylist_chain(self.llm_4o, with_image=False)
