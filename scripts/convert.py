...
class ConversionArguments:
    ...
    variant: Optional[str] = field(
        default="default", metadata={"help": "The variant of the ONNX export to use."}
    )
    opset: int = field(
        default=None,
        metadata={
    ...
    skip_onnxslim: bool = field(
        default=False, metadata={"help": "Whether or not to skip onnxslim."}
    )


def main():

    parser = HfArgumentParser((ConversionArguments, QuantizationArguments))
    ...
    if conv_args.quantize:
        ...
        use_per_channel_reduce_range = (
            config.model_type not in NO_PER_CHANNEL_REDUCE_RANGE_MODELS
        )
